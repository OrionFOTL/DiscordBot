...
namespace DiscordBot.Features.Fishing.Migrations
{
    ...
    [Migration("20231206002424_EquipmentItemDescription")]
    partial class EquipmentItemDescription
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DiscordBot.Features.Fishing.Database.GameState", b =>
                {
                    ...
                    b.Property<Guid?>("ViewingOwnedItemId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DiscordBot.Features.Fishing.Database.GameState", b =>
                {
                    ...
                    b.HasOne("DiscordBot.Features.Fishing.Entities.Equipment.OwnedItem", "ViewingOwnedItem")
                        .WithMany()
                        .HasForeignKey("ViewingOwnedItemId");

                    b.Navigation("Location");

                    b.Navigation("Player");

                    b.Navigation("ViewingOwnedItem");
                });
